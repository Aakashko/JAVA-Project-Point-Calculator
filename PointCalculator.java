...
public class PointCalculator extends JFrame implements ActionListener {
	...
	//a b are used for brackets and comma input. in a point (,) the order should be like this to implement that a, b are used
	//similarly x and y or for - and . In a point there can be max 2 - and . can be used
	char ch;
	Point temp1 = new Point();
	Point temp2 = new Point();
	Point result = new Point();
	double scl; //for scalar multiplication
	...
	public static void main(String[] args) {
		...
		try {
			//UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel"); for windows
			UIManager.setLookAndFeel("com.sun.java.swing.plaf.gtk.GTKLookAndFeel"); //for ubuntu
			//Note: The GTK+ L&F will only run on UNIX or Linux systems with GTK+ 2.2 or later installed, while the Windows L&F runs only on Windows systems. 
